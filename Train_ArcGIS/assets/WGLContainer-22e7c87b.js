import{E as F,F as V,f as H,w as Pe,C as c,d as b,L as D,r as x,R as g,I as w,bY as ce,O as U,v as M,bb as ye,c as z,z as ee,P as te,G as Z,A as $,Y as Re,V as Ne,a as Te,J as Oe,x as Ce,b as ne,gi as ze,ak as ue,hh as me,g as Fe,hi as se,ao as Ve,hj as Me,fY as pe,W as fe,hk as we,bu as Be,hl as Ue,bp as ge,$ as Ge,a3 as He,j as Ie}from"./index-cb639cc1.js";import{A as oe,g as Ye,B as We,C as ke,D as Ze,E as $e,F as Ke,G as qe,K as je,L as Xe,o as re}from"./definitions-19bfb61c.js";import{t as Y,d as Qe,m as Je,c as et,a as tt,M as nt}from"./WGLBrushVTLSymbol-69c603f9.js";import{e as B}from"./color-916b4f87.js";import{e as ot}from"./ShaderCompiler-77d0dcb6.js";import{e as ie}from"./ProgramTemplate-3f37b110.js";import{E as W,S as P,T as N}from"./enums-b1d611e3.js";import{U as it,w as at,N as rt,Z as lt,C as st,P as ct}from"./MaterialKey-a958dec2.js";import{p as Ee,s as G}from"./utils-f978585c.js";import{n as ut}from"./heatmapTextureUtils-056b357c.js";import{h as ft}from"./Container-0639ee3d.js";import{w as I}from"./number-b10bd8f5.js";let Ae=class{constructor(e,t){this._rctx=e,this._vertexBuffer=F.createVertex(e,V.STATIC_DRAW,new Uint16Array(t)),this._vao=new H(e,new Map([["a_position",0]]),{geometry:[new Pe("a_position",2,c.SHORT,0,4)]},{geometry:this._vertexBuffer}),this._count=t.length/2}bind(){this._rctx.bindVAO(this._vao)}unbind(){this._rctx.bindVAO(null)}dispose(){this._vao.dispose(!1),this._vertexBuffer.dispose()}draw(){this._rctx.bindVAO(this._vao),this._rctx.drawArrays(b.TRIANGLE_STRIP,0,this._count)}};const le={nearest:{defines:[],samplingMode:D.NEAREST,mips:!1},bilinear:{defines:[],samplingMode:D.LINEAR,mips:!1},bicubic:{defines:["bicubic"],samplingMode:D.LINEAR,mips:!1},trilinear:{defines:[],samplingMode:D.LINEAR_MIPMAP_LINEAR,mips:!0}},_t=(_,e,t)=>{if(t.samplingMode==="dynamic"){const{state:n}=_,i=e.resolution/e.pixelRatio/n.resolution,o=Math.round(_.pixelRatio)!==_.pixelRatio,a=i>1.05||i<.95;return n.rotation||a||o||e.isSourceScaled||e.rotation?le.bilinear:le.nearest}return le[t.samplingMode]};let dt=class extends Y{constructor(){super(...arguments),this._desc={vsPath:"raster/bitmap",fsPath:"raster/bitmap",attributes:new Map([["a_pos",0]])}}dispose(){this._quad&&this._quad.dispose()}prepareState({context:e}){e.setBlendingEnabled(!0),e.setColorMask(!0,!0,!0,!0),e.setStencilWriteMask(0),e.setStencilTestEnabled(!0)}draw(e,t){const{context:n,renderingOptions:i,painter:o,requestRender:a,allowDelayedRender:r}=e;if(!t.source||!t.isReady)return;const s=_t(e,t,i),l=o.materialManager.getProgram(this._desc,s.defines);if(r&&x(a)&&!l.compiled)return void a();e.timeline.begin(this.name),t.blendFunction==="additive"?n.setBlendFunctionSeparate(g.ONE,g.ONE,g.ONE,g.ONE):n.setBlendFunctionSeparate(g.ONE,g.ONE_MINUS_SRC_ALPHA,g.ONE,g.ONE_MINUS_SRC_ALPHA),n.setStencilFunction(w.EQUAL,t.stencilRef,255),this._quad||(this._quad=new Ae(n,[0,0,1,0,0,1,1,1]));const{coordScale:f,computedOpacity:m,transforms:u}=t;t.setSamplingProfile(s),t.bind(e.context,oe),n.useProgram(l),l.setUniformMatrix3fv("u_dvsMat3",u.dvs),l.setUniform1i("u_texture",oe),l.setUniform2fv("u_coordScale",f),l.setUniform1f("u_opacity",m),this._quad.draw(),e.timeline.end(this.name)}};const vt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
